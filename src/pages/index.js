...
<DefaultLayout>
  ...
  <div className="max-w-6xl mx-auto mt-72 md:mt-0">
    <div className="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-0 md:gap-4">
      ...
      <div className="w-full bg-white p-6 shadow">
        ...
        <div className="mt-2 flex justify-center text-lg">
          <p className="text-center w-5/6">Software Engineer working on an EMR system for a non-profit.</p>
        </div>
        <div className="flex pb-4 mt-4 items-center border-b">
          <button className="py-2 rounded flex-1 bg-green-500 text-white">
            <i className="fas fa-plus-circle" /> Add to Story
          </button>
                ...
                <div className="border rounded-lg">
                  <div className="flex items-center space-x-4 p-4">
                    <div className="flex items-center p-4 bg-green-400 text-white rounded-lg">
                      <svg xmlns="http://www.w3.org/2000/svg" className="fill-current w-7 h-7" width={24} height={24}
                        viewBox="0 0 24 24">
                        <path
      ...
      <div className="items-center max-w-lg bg-white shadow overflow-hidden mx-auto">
        <div className="py-4 px-8 mt-3">
          <div className="flex flex-col mb-8">
            ...
            <p className="text-gray-500 text-base">We working as a giant team with worldwide best freelancers. When we
              take over, you will relax on your path. </p>
          </div>
          ...
          <div className="py-4">
            <a href="#"
              className="block tracking-widest uppercase text-center shadow bg-green-400 hover:bg-green-600 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded">Hire
              Us</a>
          </div>
        </div>
      </div> */}
