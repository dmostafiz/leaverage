  ...
  <div className="mb-1 tracking-wide px-4 ">
    ...
    <div className="border-b -mx-8 px-8 ">
      <div className="flex items-center mt-1">
        ...
        <div className="w-3/5">
          <div className="bg-gray-300 w-full rounded-lg h-2">
            <div className=" w-7/12 bg-green-600 rounded-lg h-2" />
          </div>
        </div>
      ...
      <div className="flex items-center mt-1">
        ...
        <div className="w-3/5">
          <div className="bg-gray-300 w-full rounded-lg h-2">
            <div className="w-1/5 bg-green-600 rounded-lg h-2" />
          </div>
        </div>
        <div className="w-1/5 text-gray-700 pl-3">
      ...
      <div className="flex items-center mt-1">
        ...
        <div className="w-3/5">
          <div className="bg-gray-300 w-full rounded-lg h-2">
            <div className=" w-3/12 bg-green-600 rounded-lg h-2" />
          </div>
        </div>
        <div className="w-1/5 text-gray-700 pl-3">
      ...
      <div className="flex items-center mt-1">
        ...
        <div className="w-3/5">
          <div className="bg-gray-300 w-full rounded-lg h-2">
            <div className=" w-2/12 bg-green-600 rounded-lg h-2" />
          </div>
        </div>
        <div className="w-1/5 text-gray-700 pl-3">
    ...
    <div className="md:grid md:grid-cols-2 md:gap-4 space-y-4 md:space-y-0 mt-4">
      <div className="border rounded-lg">
        <div className="flex items-center space-x-4 p-4">
          <div className="flex items-center p-4 bg-green-600 text-white rounded-lg">
...
<h3 className="font-medium tracking-tight">We working as a giant</h3>
  ...
  <div className="max-w-lg bg-white shadow  overflow-hidden mx-auto">
