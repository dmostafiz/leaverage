...
const UpdateSlider = () => {
    ...
    useEffect(async () => {
        const response = await axios.get(`${process.env.API}/slider/get/${id}`)
        //    console.log(response.data);
        const slider = await response.data
        ...
        setTemporaryImage(slider.image)
        setStatus(slider.status)
        setHasBtn(slider.hasButton)
    
        setButtonName(slider.buttonName)
        setButtonLink(slider.buttonLink)
        setButtonColor(slider.buttonTextColor)
        setButtonBgColor(slider.buttonBgColor)
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await axios.post(`${process.env.API}/slider/save/${sliderID}`, body, { headers })
    ...
    return (
        <div>
            ...
            <div className="az-content-label mg-b-5">Update Slider</div>
            ...
            <div className="mb-5">
                ...
                <div className="mt-5">
                    ...
                    <button onClick={(e) => handleReset(e)} className="btn btn-dark pd-x-30">Go Back</button>
