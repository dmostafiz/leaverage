  ...
  <div className="container max-w-6xl">
    <div className="row intro">
      ...
      <div className="col-12 col-md-3 align-self-end">
        <a href="#" className="btn mx-auto mr-md-0 ml-md-auto primary-button"><i className="mb-4 icon-grid" />VIEW ALL</a>
      </div>
    </div>
    <div className="row justify-content-center text-center items">
      <div className="col-12 col-md-6 col-lg-4 item">
        <div className="card">
          <i className="mb-4 icon icon-globe" />
          <h4 className="text-2xl font-semibold mb-3">Website Pro</h4>
          <p>We build professional responsive websites optimized for the most popular search engines.</p>
          <a href="#" className="mt-3"><i className=" btn-icon icon-arrow-right-circle" /></a>
        </div>
      </div>
      <div className="col-12 col-md-6 col-lg-4 item">
        <div className="card">
          <i className="mb-4 icon icon-basket" />
          <h4 className="text-2xl font-semibold mb-3">E-Commerce</h4>
      ...
      <div className="col-12 col-md-6 col-lg-4 item">
        <div className="card">
          <i className="mb-4 icon icon-screen-smartphone" />
          <h4 className="text-2xl font-semibold mb-3">Mobile Apps</h4>
      ...
      <div className="col-12 col-md-6 col-lg-4 item">
        <div className="card">
          <i className="mb-4 icon icon-layers" />
          <h4 className="text-2xl font-semibold mb-3">Web Application</h4>
      ...
      <div className="col-12 col-md-6 col-lg-4 item">
        <div className="card">
          <i className="mb-4 icon icon-chart" />
          <h4 className="text-2xl font-semibold mb-3">Digital Marketing</h4>
      ...
      <div className="col-12 col-md-6 col-lg-4 item">
        <div className="card">
          <i className="mb-4 icon icon-bulb" />
          <h4 className="text-2xl font-semibold mb-3">Brand Creation</h4>
